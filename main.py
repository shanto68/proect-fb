...
try:
    ...
    if top_image:
        candidate_images.insert(0, top_image)
...
if local_images:
    # First image with short caption (500 char max)
    ...
    # No images → normal feed post with full article
...
# -----------------------------
# 🔟 Auto-comment (full article if needed)
# -----------------------------
if fb_result:
